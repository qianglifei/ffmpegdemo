...
Java_com_bksx_mobile_terminal_ffmpegdemo_FFmpegHandle_initVideo(JNIEnv *env, jobject instance,
                                                                jstring url_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_bksx_mobile_terminal_ffmpegdemo_FFmpegHandle_onFrameCallback(JNIEnv *env, jobject instance,
                                                                      jbyteArray buffer_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_bksx_mobile_terminal_ffmpegdemo_FFmpegHandle_close(JNIEnv *env, jobject instance) {
    if (video_st)
